...
pickle.dump(h_res, open("./scripts/to_output/VI_nivel_scale_u.pkl", "wb"))
...
pickle.dump(h_res, open("./scripts/to_output/VI_basin_scale_using_nivel_u.pkl", "wb"))