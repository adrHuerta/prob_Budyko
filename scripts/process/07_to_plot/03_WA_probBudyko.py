...
ax.set_xlabel("Indice de aridez")
ax.set_ylabel("Indice de evaporación")
...
ax8.set_ylim(0,1.1)
ax8.set_xlabel("Indice de aridez")
ax8.set_ylabel("Indice de evaporación")
...
ax2.grid(False)
ax2.set_title("Indice de evaporación")
...
ax3.grid(False)
ax3.set_title("Indice de aridez")
plt.tight_layout()

fig2.savefig("./output/figures/05_Ai_Ei_spatial.png", bbox_inches='tight')
plt.close()

# SPATIAL Ai / Ei / omega DISTRIBUTION WITH LAWS

fig3, (ax4, ax5, ax6) = plt.subplots(1, 3, figsize=(10, 4), dpi=150)
...
ax4.axis('off')
ax4.set_ylim(-18.5, 0)
ax4.set_xlim(-81.3, -68.7)
ax4.grid(False)
ax4.set_title("Indice de evaporación")
...
ax5.axis('off')
ax5.set_ylim(-18.5, 0)
ax5.set_xlim(-81.3, -68.7)
ax5.grid(False)
ax5.set_title("Indice de aridez")
...
ax6.axis('off')
ax6.set_ylim(-18.5, 0)
ax6.set_xlim(-81.3, -68.7)
ax6.grid(False)
ax6.set_title(r'$\omega$')
plt.tight_layout()
...
ax9.set_ylim(0, 1.1)
ax9.set_xlabel("Indice de aridez")
ax9.set_ylabel("Indice de evaporación")
...
ax10.plot([2.6, 2.6], [0, 15], "--", color="black")
ax10.set_xlim(0, 7)
ax10.set_ylim(0, 6)
...
ax11.plot([2.6, 2.6], [0, 35], "--", color="black")
ax11.set_xlim(0, 7)
ax11.set_ylim(0, 20)
...
ax12.plot([2.6, 2.6], [0, 15], "--", color="black")
ax12.set_xlim(0, 7)
ax12.set_ylim(0, 6)
...
fig5.savefig("./output/figures/07_Curve_and_omega.png", bbox_inches='tight')
plt.close()